...
type DropletInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/eaglesemanation/provider-digitalocean/apis/cluster/image/v1alpha1.Image
	...
	// +crossplane:generate:reference:type=github.com/eaglesemanation/provider-digitalocean/apis/cluster/sshkey/v1alpha1.Key
	// +listType=set
