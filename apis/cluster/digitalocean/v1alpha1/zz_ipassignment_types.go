...
type IPAssignmentInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/eaglesemanation/provider-digitalocean/apis/cluster/digitalocean/v1alpha1.Droplet
	...
	// +crossplane:generate:reference:type=github.com/eaglesemanation/provider-digitalocean/apis/cluster/digitalocean/v1alpha1.IP
