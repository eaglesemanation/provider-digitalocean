...
type DropletInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/eaglesemanation/provider-digitalocean/apis/cluster/digitalocean/v1alpha1.Image
	...
	// +crossplane:generate:reference:type=github.com/eaglesemanation/provider-digitalocean/apis/cluster/digitalocean/v1alpha1.Key
	// +listType=set
