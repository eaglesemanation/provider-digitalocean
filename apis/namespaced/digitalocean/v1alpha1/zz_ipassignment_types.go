...
type IPAssignmentInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/eaglesemanation/provider-digitalocean/apis/namespaced/digitalocean/v1alpha1.Droplet
	...
	// +crossplane:generate:reference:type=github.com/eaglesemanation/provider-digitalocean/apis/namespaced/digitalocean/v1alpha1.IP
	IPAddress *string `json:"ipAddress,omitempty" tf:"ip_address,omitempty"`

	// Reference to a IP in digitalocean to populate ipAddress.
	// +kubebuilder:validation:Optional
	IPAddressRef *v1.NamespacedReference `json:"ipAddressRef,omitempty" tf:"-"`

	// Selector for a IP in digitalocean to populate ipAddress.
	// +kubebuilder:validation:Optional
