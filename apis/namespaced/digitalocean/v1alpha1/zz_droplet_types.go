...
type DropletInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/eaglesemanation/provider-digitalocean/apis/namespaced/digitalocean/v1alpha1.Image
	Image *string `json:"image,omitempty" tf:"image,omitempty"`

	// Reference to a Image in digitalocean to populate image.
	// +kubebuilder:validation:Optional
	ImageRef *v1.NamespacedReference `json:"imageRef,omitempty" tf:"-"`

	// Selector for a Image in digitalocean to populate image.
	// +kubebuilder:validation:Optional
	...
	// +crossplane:generate:reference:type=github.com/eaglesemanation/provider-digitalocean/apis/namespaced/digitalocean/v1alpha1.Key
	// +listType=set
	SSHKeys []*string `json:"sshKeys,omitempty" tf:"ssh_keys,omitempty"`

	// References to Key in digitalocean to populate sshKeys.
	// +kubebuilder:validation:Optional
	SSHKeysRefs []v1.NamespacedReference `json:"sshKeysRefs,omitempty" tf:"-"`

	// Selector for a list of Key in digitalocean to populate sshKeys.
	// +kubebuilder:validation:Optional
...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,managed,digitalocean}
type Droplet struct {
