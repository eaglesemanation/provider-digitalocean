...
type DropletInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/eaglesemanation/provider-digitalocean/apis/namespaced/image/v1alpha1.Image
	...
	// +crossplane:generate:reference:type=github.com/eaglesemanation/provider-digitalocean/apis/namespaced/sshkey/v1alpha1.Key
	// +listType=set
	SSHKeys []*string `json:"sshKeys,omitempty" tf:"ssh_keys,omitempty"`

	// References to Key in sshkey to populate sshKeys.
	// +kubebuilder:validation:Optional
	SSHKeysRefs []v1.NamespacedReference `json:"sshKeysRefs,omitempty" tf:"-"`

	// Selector for a list of Key in sshkey to populate sshKeys.
	// +kubebuilder:validation:Optional
